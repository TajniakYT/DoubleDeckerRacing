...
public class PrometeoCarController2 : MonoBehaviour, CarInputs.ICarInputsMapActions
{
    ...
    // --- Input System fields ---
    private CarInputs carInputs; // generated input class
    ...
    void OnEnable()
    {
        // Input System setup: create and enable generated input wrapper, set callbacks to this
        if (carInputs == null)
        {
            carInputs = new CarInputs();
            carInputs.CarInputsMap.SetCallbacks(this); // generated map name assumed CarInputsMap
        }
        carInputs.Enable();
    }
    ...
    void OnDisable()
    {
        if (carInputs != null)
        {
            carInputs.CarInputsMap.SetCallbacks(null);
            carInputs.Disable();
        }
    }
    ...
    void Update()
    {
        ...
        else if (carInputs != null) // New Input System branch
        {
            ...
            // Steering: smooth towards steerInput (-1..1)
    ...
    // --- steering, animate wheels, engine/brake/handbrake methods unchanged ---
